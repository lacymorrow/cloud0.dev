...
// Must match .mdx and nothing else. Next's general swc-loader rule also
// matches "page.mdx" (its test covers ts/tsx/js/mdx together); tagging that one
// puts every server-compiled module, including src/pages, in the RSC layer and
// breaks the Pages Router. Only an MDX-exclusive rule qualifies.
